...
export const en: Record<string, string> = {
  ...
  'tui.menudetail.update': 'check GitHub for a newer QAQ or DSH; press again to confirm (Beta)',
  ...
  'tui.update.dsh.checking': 'Checking DSH updates…',
  'tui.update.dsh.latest': 'DSH up to date (v{version})',
  'tui.update.dsh.available': 'DSH update v{latest} available (current v{current}) — press this item again to apply',
  'tui.update.dsh.hasNew': 'DSH update v{version}',
  'tui.update.dsh.failed': 'DSH check failed: {error}',
  'tui.update.dsh.running': 'DSH is running — stop it before updating',
  'tui.update.dsh.notCheckout': 'No DSH source checkout — source-level update unavailable (PATH/npm installs: update with `npm i -g @deepseek-ai/dsh`)',
  'tui.update.dsh.applying': 'Applying DSH update v{version}…',
  'tui.update.dsh.applied': 'DSH updated to v{version}. Start it with menu [1] / `qaq dsh web` to take effect.',
  'tui.update.dsh.rolledBack': 'DSH update failed — rolled back to the previous version',
  'cli.dshupdate.notCheckout': 'source-level update needs a git checkout; none found (try --cwd or QAQ_DSH_CMD)',
  'cli.dshupdate.checking': 'Checking DSH updates…',
  'cli.dshupdate.latest': 'DSH up to date (v{version})',
  'cli.dshupdate.available': 'DSH update v{latest} available (current v{current})',
  'cli.dshupdate.failed': 'DSH update check failed: {error}',
  'cli.dshupdate.running': 'DSH is currently running (heartbeat/port busy) — stop it before updating',
  'cli.dshupdate.aborted': 'Update aborted.',
  'cli.dshupdate.confirm': 'Apply DSH update v{version} ({tag})? (y/N) ',
  'cli.dshupdate.applying': 'Applying DSH update v{version}…',
  'cli.dshupdate.done': 'DSH updated to v{version}. Run `qaq tui` and press [1] (or `qaq dsh web`) to boot the new version under the guard.',
  'cli.dshupdate.rolledBack': 'DSH update failed — rolled back to the previous version',
...
export const zh: Record<string, string> = {
  ...
  'tui.menudetail.update': '从 GitHub 检测 QAQ / DSH 新版本；发现更新后再次按本项确认（Beta）',
  ...
  'tui.update.dsh.checking': '正在检测 DSH 更新…',
  'tui.update.dsh.latest': 'DSH 已是最新版本 v{version}',
  'tui.update.dsh.available': '发现 DSH 新版本 v{latest}（当前 v{current}）——再次按本项确认应用',
  'tui.update.dsh.hasNew': 'DSH 有新版本 v{version}',
  'tui.update.dsh.failed': 'DSH 更新检测失败：{error}',
  'tui.update.dsh.running': 'DSH 正在运行——请先停止再更新',
  'tui.update.dsh.notCheckout': '未找到 DSH 源码目录——源码级更新不可用（PATH/npm 安装请用 `npm i -g @deepseek-ai/dsh` 自行升级）',
  'tui.update.dsh.applying': '正在应用 DSH 更新 v{version}…',
  'tui.update.dsh.applied': 'DSH 已更新到 v{version}。之后用菜单 [1] / `qaq dsh web` 在守卫下启动新版本。',
  'tui.update.dsh.rolledBack': 'DSH 更新失败——已回滚到原版本',
  'cli.dshupdate.notCheckout': '源码级更新需要一个 git checkout；未找到（可尝试 --cwd 或 QAQ_DSH_CMD）',
  'cli.dshupdate.checking': '正在检测 DSH 更新…',
  'cli.dshupdate.latest': 'DSH 已是最新版本 v{version}',
  'cli.dshupdate.available': '发现 DSH 新版本 v{latest}（当前 v{current}）',
  'cli.dshupdate.failed': 'DSH 更新检测失败：{error}',
  'cli.dshupdate.running': 'DSH 正在运行（心跳/端口占用）——请先停止再更新',
  'cli.dshupdate.aborted': '已取消更新。',
  'cli.dshupdate.confirm': '应用 DSH 更新 v{version}（{tag}）？(y/N) ',
  'cli.dshupdate.applying': '正在应用 DSH 更新 v{version}…',
  'cli.dshupdate.done': 'DSH 已更新到 v{version}。运行 `qaq tui` 按 [1]（或 `qaq dsh web`）在守卫下启动新版本。',
  'cli.dshupdate.rolledBack': 'DSH 更新失败——已回滚到原版本',
